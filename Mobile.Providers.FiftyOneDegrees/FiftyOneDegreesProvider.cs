...
{
    public class FiftyOneDegreesProvider : IDeviceInfoProvider
    {
        /// <summary>
        ...
        private EkDeviceInfo ConvertDeviceInfo(Match device)
        {
            ...
            ret.SupportOrientation = device["DeviceOrientation"] != null ? device["DeviceOrientation"].ToBool() : ret.SupportOrientation;
            ret.DeviceName = ret.DeviceModel;
            ret.DeviceOs = device["PlatformName"] != null ? device["PlatformName"].ToString() : ret.DeviceOs;
